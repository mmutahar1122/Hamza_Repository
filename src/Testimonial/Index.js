...
{/* 
  ...
  <div className="carousel-inner">
    <div className="carousel-item active">
      <img src="assets/img/testimonials/review1.jpeg" className="d-block w-100 " alt="..."/>
    </div>
    <div className="carousel-item">
      <img src="assets/img/testimonials/review2.jpeg" className="d-block w-100" alt="..."/>
    </div>
    <div className="carousel-item">
      <img src="assets/img/testimonials/review3.jpeg" className="d-block w-100" alt="..."/>
    </div>
  </div>
